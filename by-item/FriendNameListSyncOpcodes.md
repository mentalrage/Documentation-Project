...
IDA decompilation of `sub_53F830`, `0x0053f830-0x0053f921`, shows the dialog OK path iterating 20 entries, reading text control values, storing them back to `g_pConfig + 2691552 + slot*4`, trimming or normalizing against `off_67027C`, checking `byte_66DEE0`, and calling `sub_574E50(g_packetSender)` only when the flag is enabled. This ties the UI editor, global flag, and outbound opcode helper together from binary evidence.
