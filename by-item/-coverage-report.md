...
- [UID:0000U5][BuildFramePartPanes_004B7120](by-item/BuildFramePartPanes_004B7120.md) : reconstructable : 68% : strong : FramePartPane factory with exact boundary, constructor calls, slot writes, cleanup link, and unresolved live reachability documented.
...
- [UID:0000UO][FolderTreePaneOwnerPollution_47f280_58a8e0](by-item/FolderTreePaneOwnerPollution_47f280_58a8e0.md) : reconstructable : 60% : strong : - IDA function clusters confirm separate FolderTreePane, chat, surface/presentation, and system-message ownership groups; final per-helper owners remain medium confidence.
...
- [UID:0000UX][LoadFrameDrawRecord_004D1600](by-item/LoadFrameDrawRecord_004D1600.md) : reconstructable : 68% : strong : Exact by-memory page now documents IDA MCP boundary, caller/callee inventory, projection behavior, table offsets, and unresolved field relation.
