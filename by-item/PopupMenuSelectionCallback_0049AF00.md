...
- Current generated source: `source-3/simroot_v2/class_PlainMemberFunctionObject_void____thiscall_PopupMenuControlPane_____long____class_PopupMenuControlPane_.cpp`
...
- Active simroot emits the helper under the very long generated filename above, which is difficult to search reliably. Use this page's short alias when linking documentation.
- The matching generated class page is [UID:0000AK][PlainMemberFunctionObject_void____thiscall_PopupMenuControlPane_____long____class_PopupMenuControlPane_](by-class/PlainMemberFunctionObject_void____thiscall_PopupMenuControlPane_____long____class_PopupMenuControlPane_.md).
- The generated metadata/disabled output also mentions `0x004d0050` as a no-op, but IDA currently resolves that address inside `sub_4CFFB0`. Keep `0x004d0050` out of this item until the data issue is fixed.
- 2026-05-25 current-state recheck: active `simroot_v2` source still emits only this `Invoke` body. The disabled source and `.meta_wave3` still carry `NoOp` at `0x004d0050`, but IDA `xrefs_to 0x004d0050` reports only an internal code xref from `0x004d004e` in `sub_4CFFB0`, while `0x0049af00` has only data/vtable references.
...
Keep this helper with [UID:0000MN][PopupMenuControls](by-file/PopupMenuControls.md) unless a later pass identifies a broader reusable function-object support module. It is small compiler-template glue; do not migrate it into [UID:0000N7][RightButtonMenuPane](by-file/RightButtonMenuPane.md), [UID:0000L8][MenuVarietyPanes](by-file/MenuVarietyPanes.md), or a caller-specific dialog source.
