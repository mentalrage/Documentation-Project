...
- 2026-06-05 autogen classification:
  ...
  - Summary/evidence: live IDA MCP `xrefs_to 0x0069ba34` and decompilation of `0x00549c20`, `0x0054a480`, `0x0054a4b0`, `0x0054b000`, and `0x0054b520` prove NexusTK-owned `PowerDialogPane` singleton storage owned by [UID:0000MO][PowerDialogPane](by-file/PowerDialogPane.md). No final C++ body was added because the page is below the 95/95 reconstruction gate.
