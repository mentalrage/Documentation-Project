...
- Current active `source-3/simroot_v2/class_HistoryViewingPane.cpp` emits constructor/destructor references but does not emit the `0x005023b0` singleton clear helper.
...
- Generated `recovered/CloseMainMenuDialogSingletons_004F69A0.cpp` marks this singleton for deletion when a main-menu cleanup pass runs.
