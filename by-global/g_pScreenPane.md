...
- Confidence: strong for address, ScreenPane singleton ownership, and alias consolidation.
...
- Reconstruction status: attached to the ScreenPane source root as source-declared singleton storage; final C++ remains blank until the ScreenPane layout, header exposure, and cursor/surface helper split are ready for final-source code.
...
- The small helper at `0x00559b20` also clears `dword_67A7CC` directly and appears to be scalar/vector deleting or cleanup-adjacent support for the same object family.
...
| `0x00559b20` | clear | [UID:00023U][0x00559b20-0x00559b8b.ScreenPaneDestructorThunkIsland](by-memory/0x00559b20-0x00559b8b.ScreenPaneDestructorThunkIsland.md) starts with a compact singleton-clear helper. |
