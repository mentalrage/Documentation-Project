...
- 2026-06-07 A002 Batch 078 IDA MCP recheck reconfirmed `0x0069ba28` as `.data` item `dword_69BA28`, size `4`, bytes/value `ff ff ff ff` / `0xffffffff`, with the same nine refs in `sub_545E40`, `sub_546290`, `sub_546440`, `sub_546D70`, `sub_546E80`, and `sub_547000`.
...
| `0x00546e80-0x00546e8b` | write `0` | [UID:0002KN][0x00546e80-0x00546e8b.ClearParcelPaneSingleton](by-memory/0x00546e80-0x00546e8b.ClearParcelPaneSingleton.md) is the compact file-scope clear helper for this slot. |
...
- Live IDA MCP reconfirmed the exact storage as `dword_69BA28`, four bytes in `.data`, initialized to `ff ff ff ff`, with nine data xrefs.
...
- 2026-06-05 autogen classification:
  ...
  - Summary/evidence: live IDA MCP `xrefs_to 0x0069ba28` and decompilation of `0x00545e40`, `0x00546290`, `0x00546440`, `0x00546d70`, `0x00546e80`, and `0x00547000` prove NexusTK-owned `ParcelPane` singleton storage owned by [UID:0000MF][ParcelPane](by-file/ParcelPane.md). No final C++ body was added because the page is below the 95/95 reconstruction gate.
