...
- Address ranges: `0x0069be14-0x0069bec4` and `0x0069bec8-0x0069bed0` for currently confirmed dispatch-pointer storage. The intervening `0x0069bec4-0x0069bec8` slot is a browser/transport callback and is documented separately.
...
Other confirmed entries include wide `FindWindow`, `CreateFile`, `CreateWindowEx`, `DispatchMessage`, registry APIs, `SetCurrentDirectory`, version APIs, IME APIs, `SendMessage`, `GetLocaleInfo`, and `SetFileAttributes` pointers.
