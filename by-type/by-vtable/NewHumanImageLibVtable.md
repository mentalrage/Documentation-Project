...
- `0x004dfd78` in [UID:00017R][0x004dfd10-0x004e68a8.NewHumanImageLib](by-memory/0x004dfd10-0x004e68a8.NewHumanImageLib.md)
...
- 2026-06-08 A008 Batch 128 parent attachment:
  ...
  - Summary/evidence: live IDA MCP reconfirmed the constructor/destructor vtable-base xrefs and the old/new human singleton separation. The vtable is a compiler-emitted artifact of the `NewHumanImageLib` class declaration, so the class page is the direct type parent. Final C++ remains blank because this page should not emit table bytes.
