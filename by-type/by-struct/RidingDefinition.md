...
- [UID:0002LA][0x004dc420-0x004dc68d.RidingImageLibLoadRidingDefinitions](by-memory/0x004dc420-0x004dc68d.RidingImageLibLoadRidingDefinitions.md) reads definition records in the exact order `+0x00` dword, `+0x04` byte, `+0x05` byte, and `+0x06` word.
