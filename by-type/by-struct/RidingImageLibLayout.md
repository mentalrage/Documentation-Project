...
- [UID:0002LA][0x004dc420-0x004dc68c.RidingImageLibLoadRidingDefinitions](by-memory/0x004dc420-0x004dc68c.RidingImageLibLoadRidingDefinitions.md) reads the first dword of `RIDINGS.DNA` as the riding definition count, allocates `count * 0x0c + 4`, constructs `0x0c`-byte [UID:0001VV][RidingDefinition](by-type/by-struct/RidingDefinition.md) rows, then stores the element pointer at `+0x04` and count at `+0x08`.
...
- 2026-05-31 `lookup_funcs` reports the constructor at `0x004dc690` size `0x92`, ordinary destructor at `0x004dc730` size `0xa8`, and scalar deleting destructor at `0x004e68b0` size `0xd1`.
