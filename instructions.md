...
- Git is only a backup/sync tool for this documentation work. Only stop to commit/push after roughly 30 minutes of work or after a large batch of about 50+ meaningful edits; do not interrupt smaller documentation passes for Git.
