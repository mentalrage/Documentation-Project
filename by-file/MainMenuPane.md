...
- 2026-06-03 IDA MCP recheck confirms `OpenTransferServerDialog_4F8F10` is a real retained helper between `HandleLegacyMainMenuPacket_4F8D00` and `OpenCreateUserDialog_4F8FA0`; it calls timer helper `0x00597a10` through [UID:0000SI][g_pTimerMgr](by-global/g_pTimerMgr.md), allocates `0x100`, and constructs `TransferServerDialogPane` at `0x00598ed0`, with no direct caller/xref or raw little-endian pointer reference to `0x004f8f10` found.
