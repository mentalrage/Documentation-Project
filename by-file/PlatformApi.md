...
- IDA MCP confirms a real initializer at [UID:0000WD][0x0041a280-0x0041a4a8.WideApiDispatchInit](by-memory/0x0041a280-0x0041a4a8.WideApiDispatchInit.md): it calls `GetVersionExA`, installs the main `0x0069be14-0x0069bec4` dispatch-pointer table and tail `0x0069bec8-0x0069bed0` dispatch pointers on NT-family Windows, writes `_wfopen` to `dword_69BE14`, writes `_wstat64i32` to `dword_69BE18`, and registers [UID:0001O9][0x0060c440-0x0060c44b.UniAPIInitStaticCleanupWrapper](by-memory/0x0060c440-0x0060c44b.UniAPIInitStaticCleanupWrapper.md) through `atexit`. The intervening `0x0069bec4-0x0069bec8` slot is [UID:0001Q1][0x0069bec4-0x0069bec8.g_browserControlKeyCallback](by-memory/0x0069bec4-0x0069bec8.g_browserControlKeyCallback.md), not a platform dispatch entry.
