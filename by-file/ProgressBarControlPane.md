...
The private helpers at `0x00494a90`, `0x00494af0`, and `0x00494db0` should be grouped here only as projected helper code until IDA/Wave3 function ownership is corrected. Do not migrate them as public imported methods yet.
