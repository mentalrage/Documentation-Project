...
| [UID:00006X][ItemWhoInputPane](by-class/ItemWhoInputPane.md) | `0x005aec60-0x005af3af`, thunks/destructor at `0x005b780a-0x005b7aec` | `class_ItemWhoInputPane.cpp` plus missing active helper owners | Use-on-target prompt that accepts typed or mouse-selected targets. |
...
- `0x005af3b0` is not currently an IDA function; keep the `0x005af390` helper as an exact small helper, not a broad range extending through padding.
