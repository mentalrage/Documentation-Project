...
- `Decoder.cpp` owns the in-memory reader at `0x004a5640-0x004a5e23`, including the [UID:00013Q][0x004a5680-0x004a5dce.DecoderRawReaderFamily](by-memory/0x004a5680-0x004a5dce.DecoderRawReaderFamily.md) in `0x004a5680-0x004a5db0` that current IDA does not model as functions.
...
- [UID:0000HL][AttachmentAnchorResolver](by-file/AttachmentAnchorResolver.md) is staged as neighboring `map/AttachmentAnchorResolver.cpp` source for now. The 2026-06-03 split added raw/modeled helper siblings around `0x0053c6b0-0x0053ca1b`, including [UID:0002TZ][0x0053c9c0-0x0053c9eb.AttachmentAnchorApplyLight](by-memory/0x0053c9c0-0x0053c9eb.AttachmentAnchorApplyLight.md); final migration may still fold this helper file into `AttachedObjectPane.cpp`.
