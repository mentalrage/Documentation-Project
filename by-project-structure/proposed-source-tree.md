...
- [UID:0000MI][PathUtil](by-file/PathUtil.md) stages `PathUtil.cpp` for [UID:0000V6][PathExistsViaStat_00582460](by-item/PathExistsViaStat_00582460.md), a shared `_wstat`-based wide-path probe at `0x00582460-0x00582494`; folding it into `StdioFile.cpp` remains a documented final-source alternative if later evidence shows the original file I/O layer was more compact.
