...
- `sub_55A5E0` is `0x0055a5e0-0x0055a61b` and is referenced from vtable slot `0x006237a8`. Its disassembly loads frame metadata through `sub_4D02F0([UID:0000QU][g_pEPFLib](by-global/g_pEPFLib.md) / dword_67A744, this+0xfc, *(word *)(this+0x168), this+0x140)`, then renders through `sub_4BA6B0(this, this+0x44, this+0x140, this+0x11c)`.
- `sub_55A620` is `0x0055a620-0x0055a6ea`; it calls [UID:00009W][OverlayEffecter](by-class/OverlayEffecter.md) at `0x0055a651`, installs the four `OverlayFrameImageEffecter` vtable views at `0x0055a663`, `0x0055a669`, `0x0055a670`, and `0x0055a67a`, initializes scratch frame state through `sub_457A60`, loads the frame table via `sub_4D0F50([UID:0000QU][g_pEPFLib](by-global/g_pEPFLib.md) / dword_67A744, source, 0)`, copies two 16-wide-character names into `this+0x100` and `this+0x120`, stores a word parameter at `this+0x16c`, and sets visible/active byte `this+0xf9`.
