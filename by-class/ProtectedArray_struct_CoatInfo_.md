...
- Current generated file: `source-3/simroot_v2/class_ProtectedArray_struct_CoatInfo_.cpp`
...
| --- | --- | --- |
| `0x004e5aa0` | ordinary destructor | Resets `ProtectedArray<CoatInfo>` vtable and frees backing storage. |
| `0x004e6030` | scalar deleting destructor | Ordinary cleanup plus conditional `operator delete`. |

## Ownership Notes

This is old human equipment metadata support, not an independent original class source file.
