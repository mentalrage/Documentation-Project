...
- Current generated file: `source-3/simroot_v2/class_ProtectedArray_struct_NecklaceInfo_.cpp`
...
| --- | --- | --- |
| `0x004e5b40` | ordinary destructor | Resets `ProtectedArray<NecklaceInfo>` vtable and frees backing storage. |
| `0x004e6210` | scalar deleting destructor | Ordinary cleanup plus conditional `operator delete`. |

## Ownership Notes

This is old human necklace metadata support, not an independent original class source file.
