...
| [UID:0002DR][0x00420de0-0x00421301.FittingRoomSelectionVectorHelpers](by-memory/0x00420de0-0x00421301.FittingRoomSelectionVectorHelpers.md) | selection/vector helper island | Mixed cart/selection pointer-vector and formatting helpers; source ownership still mixed/open. |
...
- The historical [UID:0000WT][0x00421310-0x004216cb.SimpleUStringSso7](by-memory/0x00421310-0x004216cb.SimpleUStringSso7.md) aggregate sits adjacent to this class but is mixed. Only the entry release helpers and scalar deleting destructor rows above should be treated as `FittingRoomListPane` evidence; the string, checkbox, generated thunk, padding, and runtime/vector rows belong elsewhere.
