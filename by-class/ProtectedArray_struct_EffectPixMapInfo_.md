...
- Current generated file: `source-3/simroot_v2/class_ProtectedArray_struct_EffectPixMapInfo_.cpp`
...
| --- | --- | --- |
| `0x004e5ac0` | ordinary destructor | Resets `ProtectedArray<EffectPixMapInfo>` vtable and frees backing storage. |
| `0x004e6090` | scalar deleting destructor | Ordinary cleanup plus conditional `operator delete`. |

## Ownership Notes

`EffectObjImageLib` owns the `EFFECT.FRM` frame-remap table logic. This page records only the shared template instantiation.
