...
- Current generated file: `source-3/simroot_v2/class_ProtectedArray_struct_MantleInfo_.cpp`
...
| --- | --- | --- |
| `0x004e5b30` | ordinary destructor | Resets `ProtectedArray<MantleInfo>` vtable and frees backing storage. |
| `0x004e61e0` | scalar deleting destructor | Ordinary cleanup plus conditional `operator delete`. |

## Ownership Notes

This is old human mantle metadata support, not an independent original class source file.
