...
| `EnsureFontSlotLoaded` | [UID:0002HS][0x004b60c0-0x004b61d9.FontImageLibEnsureFontSlotLoaded](by-memory/0x004b60c0-0x004b61d9.FontImageLibEnsureFontSlotLoaded.md) | Opens `BARAM%02d.EFT`, reads slot metrics and the 65536-entry glyph offset table. |
| `DecodeGlyphBitmap` | [UID:0002HT][0x004b61e0-0x004b6341.FontImageLibDecodeGlyphBitmap](by-memory/0x004b61e0-0x004b6341.FontImageLibDecodeGlyphBitmap.md) | Expands encoded glyph rows into the scratch buffer, writes the EPFTileContext fields, and applies caller palette/transparent-index rules. |
