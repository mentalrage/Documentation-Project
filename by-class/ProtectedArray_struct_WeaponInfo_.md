...
- Current generated file: `source-3/simroot_v2/class_ProtectedArray_struct_WeaponInfo_.cpp`
...
| --- | --- | --- |
| `0x004e5b60` | ordinary destructor | Resets `ProtectedArray<WeaponInfo>` vtable and frees backing storage. |
| `0x004e6270` | scalar deleting destructor | Ordinary cleanup plus conditional `operator delete`. |

## Ownership Notes

This is old human weapon/equipment metadata support, not an independent original class source file.
