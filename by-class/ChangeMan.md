...
- Parent/C++ status: reconstructable and attached to [UID:0000I2][ChangeMan](by-file/ChangeMan.md). Keep final class C++ blank until listener/message interface names, the `SortedList` declaration shape, and final public API signatures are source-quality.
