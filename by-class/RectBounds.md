...
- Current source-owner state: IDA-backed RectBounds and geometry-helper pages support a shared four-int bounds layout; final method versus file-local helper declarations remain under review.
...
| `InsetByQuarter` / `OutsetByQuarter` | `0x004b7af0-0x004b7c21` | Raw helper pair that writes quarter-inset or quarter-outset rectangles into an output record. |
...
- IDA-backed docs keep [UID:00015R][0x004b7910-0x004b795e.RectBoundsInset](by-memory/0x004b7910-0x004b795e.RectBoundsInset.md) and [UID:00015T][0x004b7ca0-0x004b7cb6.RectArea](by-memory/0x004b7ca0-0x004b7cb6.RectArea.md) visible as separate exact helper pages while final declaration ownership remains unresolved.
