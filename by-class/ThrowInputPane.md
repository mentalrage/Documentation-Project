...
- IDA MCP recheck on 2026-05-27 confirms the constructor uses prompt id `0x23`, calls `CharInputPane::CharInputPane`, gets the local player name from `dword_67A748`, formats the prompt, and installs vtables `0x006301ec`, `0x0063023c`, and `0x0063026c`.
