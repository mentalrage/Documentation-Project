...
`HumanImageLib::HumanImageLib` uses this accessor while populating old accessory draw metadata. Keep the template code in shared support and the data loading in `HumanImageLib`.
