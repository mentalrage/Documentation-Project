...
- The constructor reads `byte_66DA97`; when it is `1`, it checks and loads from `SYMBOLS.EPF` at `0x00610ca4`, otherwise it checks and loads from `SYMBOLS.EPD` at `0x0062e16c`.
