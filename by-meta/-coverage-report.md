...
- [UID:0001QC][client_dat_specifications](by-meta/client_dat_specifications.md) : reconstructable : 55% : medium : DAT/resource specification page with archive ownership, public APIs, mapped entry-table layout, consumer/source split, and 2026-06-16 current-package audit evidence for 250 DAT tables, null-terminated exposed names, monotonic bounded offsets, and final boundary-row name-byte caveats; exact original field/type names remain open.
