...
- [UID:0000UP][FriendNameListSyncOpcodes](by-item/FriendNameListSyncOpcodes.md) documents inbound map opcode `0x6a` and outbound opcode `0x77`. Inbound `0x6a` sets [UID:0000PG][byte_66DEE0](by-global/byte_66DEE0.md) and, when enabled, triggers [UID:0001HX][0x00574e50-0x0057536b.BuildAndSendInventoryData](by-memory/0x00574e50-0x0057536b.BuildAndSendInventoryData.md), which serializes the 20 friend/name-list config slots written by [UID:0000JN][FriendListDialog](by-file/FriendListDialog.md). The generated inventory name and `g_isCashShopEnabled` alias are provisional/misleading.
