...
- [UID:000175][0x004d05f0-0x004d0c57.ImageDecodeWrappers](by-memory/0x004d05f0-0x004d0c57.ImageDecodeWrappers.md) identify two product-owned libjpeg decode callers: `DecodeJpfImageToTileContext` at `0x004d07b0` for profile/look `JPF` portraits and `DecodeJpegBufferToTileContext` at `0x004d0a90` for minimap tile blobs.
