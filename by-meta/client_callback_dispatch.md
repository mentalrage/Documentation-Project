...
| --- | --- | --- | --- |
| `FunctionObject` base destructors | [UID:000123][0x0049b090-0x0049b28e.FunctionObjectDestructors](by-memory/0x0049b090-0x0049b28e.FunctionObjectDestructors.md) | shared utility | Duplicate emitted scalar deleting destructors with vtable data refs. |
...
| Application zero-argument callbacks | [UID:0000YU][0x004671a0-0x004673f6.ApplicationFunctionObject0Callbacks](by-memory/0x004671a0-0x004673f6.ApplicationFunctionObject0Callbacks.md) | [UID:0000HG][Application](by-file/Application.md) | Deferred application callback wrappers and base support. |
