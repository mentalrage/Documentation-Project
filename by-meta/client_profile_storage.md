...
- The `.jpf` payload is decoded through [UID:000175][0x004d05f0-0x004d0c57.ImageDecodeWrappers](by-memory/0x004d05f0-0x004d0c57.ImageDecodeWrappers.md); only a decoded span of `48 x 56` causes the profile name to be appended to the outbound packet.
